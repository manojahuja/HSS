...
# 4 "HumanInterface.cpp" 2
# 1 "SystemControllerI.cpp" 1
...
int SystemControllerI::SelfCheck()
 {
 char tempPass[10],tempPass2[10];
   int i=0;
   loop: i = i + 1;
    for(int i=0; i<10; i++,tempPass[i] = '\0',tempPass2[i]='\0');
    cout<<"Enter Your Password\n";
                         cin>>tempPass;
    cout<<"Retype Your Passowrd"
                  cin>>tempPass2;
    if(stringCompare(tempPass,tempPass2));
     return(0);
    else
     if
      {
...
int SystemControllerI::Authentication(int userType)
  {
   int retValue;
   retValue=SelfCheck();
   if(retVale==10)
   ...
   else if(returnValue==1&&userType==2)


  };
# 5 "HumanInterface.cpp" 2
...
int main()
{
   ...
   HumanInterface test;
   test.UserInterface();
       SystemStat ALARAM_STAT,SYS_STAT;
        ALARAM_STAT.GetAlaramStat();
        SYS_STAT.GetSysStat();
# 33 "main.cpp"
 return 0;
}
